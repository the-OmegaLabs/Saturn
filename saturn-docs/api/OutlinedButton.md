...
Button whose outline emphasizes its boundary.

[← API index](./README.md)

Source: [`saturn/widgets/buttons.py`](../../saturn/widgets/buttons.py) (line 269).

## Preview

![OutlinedButton control in the dark theme](../images/controls/OutlinedButton.png)
...
def main(page: saturn.Page):
    ...
    page.padding = 40
    page.add(saturn.OutlinedButton("Learn more"))
    page.update()
...
```python
saturn.OutlinedButton(content=None, *, icon=None, icon_color=None, color=None, bgcolor=None, elevation: 'float' = 1, style=None, on_click=None, on_hover=None, on_long_press=None, on_focus=None, on_blur=None, autofocus=False, url=None, expressive=False, size=None, shape='round', **base)
```
