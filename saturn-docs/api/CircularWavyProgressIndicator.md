...
源码：[`saturn/widgets/expressive_progress.py`](../../saturn/widgets/expressive_progress.py)（第 218 行）。

## 效果图

![CircularWavyProgressIndicator 控件的深色主题效果](../images/controls/CircularWavyProgressIndicator.png)
