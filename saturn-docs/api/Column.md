...
源码：[`saturn/widgets/containers.py`](../../saturn/widgets/containers.py)（第 172 行）。

## 效果图

![Column 控件的深色主题效果](../images/controls/Column.png)
...
| `alignment` | `—` | `<MainAxisAlignment.START: 'start'>` | 子控件沿垂直主轴的排列方式。 |
