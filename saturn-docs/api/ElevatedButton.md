...
Button with a subtle shadow for ordinary actions.
...
![ElevatedButton control in the dark theme](../images/controls/ElevatedButton.png)
...
def main(page: saturn.Page):
    ...
    page.padding = 40
    page.add(saturn.ElevatedButton("Elevated action", icon=saturn.Icons.ADD))
    page.update()
