...
Prominent button filled with the theme's primary color.

[← API index](./README.md)

Source: [`saturn/widgets/buttons.py`](../../saturn/widgets/buttons.py) (line 253).

## Preview

![FilledButton control in the dark theme](../../.static/controls/FilledButton.png)
...
def main(page: saturn.Page):
    ...
    page.padding = 40
    page.add(saturn.FilledButton("Continue", icon=saturn.Icons.ARROW_FORWARD))
    page.update()
...
```python
saturn.FilledButton(content=None, *, icon=None, icon_color=None, color=None, bgcolor=None, elevation: 'float' = 1, style=None, on_click=None, on_hover=None, on_long_press=None, on_focus=None, on_blur=None, autofocus=False, url=None, expressive=False, size=None, shape='round', **base)
```
